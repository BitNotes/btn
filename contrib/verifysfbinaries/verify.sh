...
WORKINGDIR="/tmp/bitnote1"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/bitnote1/bitnote1/bitnote1-0.9.0rc1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/bitnote1/bitnote1/"
VERSIONPREFIX="bitnote1-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'bitnote1-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[bitnote1-]<version>-[rc[0-9]] (example: bitnote1-0.7.1-rc1)"
   echo "wget output:"
