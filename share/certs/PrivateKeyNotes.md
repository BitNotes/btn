...
unlocked to sign the bitnote1-Qt.app bundle.
...
allowing somebody to distribute a bitnote1-Qt.app or bitnote1-qt-setup.exe with a valid
...
that the bitnote1-qt.exe file inside the installer had not been tampered with.
