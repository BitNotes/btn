...
B4ARGS="-datadir=$D4"
$bitnote1D $bitnote1DARGS $B4ARGS &
B4PID=$!
...
B3ARGS="-datadir=$D3"
$bitnote1D $bitnote1DARGS $B3ARGS &
B3PID=$!
...
function StartThree {
  $bitnote1D $bitnote1DARGS $B1ARGS &
  B1PID=$!
  $bitnote1D $bitnote1DARGS $B2ARGS &
  B2PID=$!
  $bitnote1D $bitnote1DARGS $B3ARGS &
  B3PID=$!
}
