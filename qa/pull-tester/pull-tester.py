...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old bitnote1PullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/bitnote1dComparisonTool_jar/bitnote1dComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/bitnote1/bitnote1.git")
...
environ_default("BUILD_PATH", "/mnt/bitnote1")
...
environ_default("GITHUB_REPO", "bitnote1/bitnote1")
