...
#include "bitnote1-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatbitnote1URI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + bitnote1Units::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatbitnote1URI(info));
}
