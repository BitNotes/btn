...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/bitnote1"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("bitnote1"),
     ...
     * override -datadir in the bitnote1.conf file in the default data directory
     * (to be consistent with bitnote1d behavior)
     */
    if(dataDir != getDefaultDataDirectory())
