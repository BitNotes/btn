...
public:
    CMainParams() {
        ...
        nSubsidyHalvingInterval = 220000;
        ...
        //   vMerkleTree: 4a5e1e
        const char* pszTimestamp = "Bitnote.. Begin the revolution";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        vSeeds.push_back(CDNSSeedData("bitnote1.sipa.be", "seed.bitnote1.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.bitnote1.dashjr.org"));
        vSeeds.push_back(CDNSSeedData("bitnote1stats.com", "seed.bitnote1stats.com"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("bitnote1.petertodd.org", "testnet-seed.bitnote1.petertodd.org"));
