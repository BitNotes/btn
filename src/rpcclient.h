...
#ifndef _bitnote1RPC_CLIENT_H_
#define _bitnote1RPC_CLIENT_H_ 1
...
/** Show help message for bitnote1-cli.
 ...
 *
 * @note the argument can be removed once bitnote1-cli functionality is removed from bitnote1d
 */
