bitnote1-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitnote1/files/bitnote1/bitnote1-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the bitnote1
...
New/changed settings (command-line or bitnote1.conf file)
--------------------------------------------------------
