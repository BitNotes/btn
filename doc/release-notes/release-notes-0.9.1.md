bitnote1 Core version 0.9.1 is now available from:

  https://bitnote1.org/bin/0.9.1/
...
bitnote1d from any pre-0.9.1 version, and have enabled SSL for RPC and
...
installer (on Windows) or just copy over /Applications/bitnote1-Qt (on Mac) or
bitnote1d/bitnote1-qt (on Linux).
...
- Upgrade OpenSSL to 1.0.1g. This release fixes the following vulnerabilities which can
  affect the bitnote1 Core software:
