bitnote1 version 0.7.2 is now available from:
  http://sourceforge.net/projects/bitnote1/files/bitnote1/bitnote1-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused bitnote1-Qt to crash on Windows when exiting.
